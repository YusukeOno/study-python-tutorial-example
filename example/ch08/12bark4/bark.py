...
def loop():
    ...
    options = OrderedDict({
        ...
        'G': Option('GitHubのスターをインポート', commands.ImportGitHubStarsCommand(), prep_call=get_github_import_options),
...
if __name__ == '__main__':
    ...
    commands.CreateBookmaksTableCommand().execute()
